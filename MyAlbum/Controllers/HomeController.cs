    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult Albumname(string filename)
        {
            ...
            if (Directory.Exists(path) && Album_Select.Count > 0)
                return Json("The filename has existed;" + filename);
            else
            {
                // create Album
                ...
                return Json("Albumname Successed;" + filename);
            }
        }

        [HttpPost]
        public ActionResult Pictures(string newfilename)
        {
            string path = "D:\\DataSource\\Album\\" + newfilename;
            string Albumname_big = path + "\\big";
            string Albumname_smail = path + "\\smail";
